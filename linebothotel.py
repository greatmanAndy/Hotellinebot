...
line_bot_api = LineBotApi('Vs9NcO2YCsSUtTwr6vY6omy8OnRKoKSy7I4zB7r0kSsQL9oSn0WsRLWxTXznAQkIvmQ2152LAXY1+t9CnXAyf8SY4xRsDCEjfa8VXfii/1s3+tD/p0MNROR5DmLa22hLYJbdrGhf5l7C8emhOAfNBAdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('4ef54850e7739da840323e4326821cd0')
# 定義 PostgreSQL 連線字串
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://admin:123456@127.0.0.1:5432/hotel'
db = SQLAlchemy(app)
# 定義 LIFF ID
liffid = '1657705229-aJE5AAY0'
